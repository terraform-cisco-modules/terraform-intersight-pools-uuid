...
func TestFull(t *testing.T) {
	...
	instanceName := fmt.Sprintf("test-pools-uuid-%s", uniqueId)
...
`
	...
	iassert.AssertMOComply(t, fmt.Sprintf("/api/v1/uuidpool/Pools/%s", moid), expectedJSONTemplate, vars)
}
